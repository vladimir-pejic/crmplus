        ...
        <div class="h-screen pb-14 bg-right bg-cover" style="background-image:url('bg1.jpg');">
            ...
            <div class="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                ...
                <div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden" style="background-image:url('shrtd-logo.png')">
                    <h1 class="my-4 text-3xl md:text-5xl text-blue-300 hover:text-purple-300 font-bold leading-tight text-center md:text-left slide-in-bottom">404</h1>
                    <p class="leading-normal text-white text-base md:text-2xl mb-8 text-center md:text-left slide-in-bottom-h1">Oh-oh! That's not the link you are looking for! :(</p>
                </div>
